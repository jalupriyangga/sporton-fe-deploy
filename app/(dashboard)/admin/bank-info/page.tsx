...
import BankInfoList from "@/app/(dashboard)/components/bank-info/bank-info-list";
import BankInfoModal from "@/app/(dashboard)/components/bank-info/bank-info-modal";
